...
describe('AiPricingBadge', () => {
    ...
    it('fires onApply with suggested price on button click', async () => {
        ...
        renderWithProviders(<AiPricingBadge suggestion={mockSuggestion} onApply={handleApply} />);
    ...
    it('renders with integer price values', () => {
        ...
        renderWithProviders(<AiPricingBadge suggestion={intSuggestion} onApply={vi.fn()} />);
