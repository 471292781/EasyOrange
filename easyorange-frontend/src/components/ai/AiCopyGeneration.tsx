...
export function AiCopyGeneration({ productName, onGenerate, onApply, result, isLoading }: AiCopyGenerationProps) {
            ...
            {result && (
                <div className="ai-copy-result">
                    <div className="ai-copy-result-header">
                        <Sparkles size={14} />
                        <span>
                            生成结果（{STYLE_OPTIONS.find(s => s.value === result.style)?.label || result.style}）
                        </span>
                    </div>
                    ...
                    <div className="ai-copy-result-actions">
                        <Button className="ai-copy-apply-btn" onClick={() => onApply(result)} type="button">
                            <Check size={14} />
                            采纳并填充
                        </Button>
                        <Button
