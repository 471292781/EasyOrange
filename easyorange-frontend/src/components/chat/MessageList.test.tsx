...
describe('MessageList', () => {
    ...
    it('renders messages', () => {
        mockVirtualItems = [{ index: 0, start: 0, end: 72, key: 'm1', size: 72 }];
        const messages = [makeMessage({ id: 'm1', content: 'Hello there' })];
        render(<MessageList messages={messages} currentUserId="user1" targetUserName="Bob" isTyping={false} />);
    ...
    it('shows typing indicator when isTyping is true', () => {
        mockVirtualItems = [{ index: 0, start: 0, end: 72, key: 'typing-indicator', size: 72 }];
        render(<MessageList messages={[]} currentUserId="user1" targetUserName="Bob" isTyping={true} />);
    ...
    it('does not show typing indicator when isTyping is false', () => {
        mockVirtualItems = [{ index: 0, start: 0, end: 72, key: 'typing-indicator', size: 72 }];
        render(<MessageList messages={[]} currentUserId="user1" targetUserName="Bob" isTyping={false} />);
