        ...
        <div className="footer-main-grid">
          <div className="footer-left-column">
            <div className="footer-brand-section">
              ...
              <p className="footer-tagline">AI 资产管理 · 让每一份资产,运转不息</p>
              <div className="footer-social-links">
                <Button variant="outline" size="icon" className="social-link" data-platform="wechat" aria-label="微信">
                ...
                <Button variant="outline" size="icon" className="social-link" data-platform="weibo" aria-label="微博">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <Button variant="outline" size="icon" className="social-link" data-platform="qq" aria-label="QQ">
                  <svg viewBox="0 0 24 24" fill="currentColor">
