    ...
    <footer className="footer-editorial">
      ...
      <div className="footer-container">
          ...
          <div className="footer-left-column">
            <div className="footer-brand-section">
              ...
              <div className="footer-social-links">
                <a href="#" className="social-link" data-platform="wechat" aria-label="微信">
                ...
                <a href="#" className="social-link" data-platform="weibo" aria-label="微博">
                  <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="#" className="social-link" data-platform="qq" aria-label="QQ">
                  <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="footer-right-column">
            <div className="footer-stats-row">
              <div className="stat-item-compact">
                <span className="stat-value-lg">1000+</span>
                <span className="stat-label-sm">活跃用户</span>
              </div>
              <div className="stat-divider-vertical"></div>
              <div className="stat-item-compact">
                <span className="stat-value-lg">500+</span>
                <span className="stat-label-sm">每日上新</span>
              </div>
            </div>
        ...
        <div className="footer-bottom-bar">
          ...
          <p className="copyright-info">© 2026 EasyOrange · 校园二手</p>
        </div>
      </div>
    </footer>
  )
