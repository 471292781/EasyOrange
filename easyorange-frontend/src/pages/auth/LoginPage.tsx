...
import { passwordLoginSchema, registerSchema, smsLoginSchema } from '@/schemas/authSchema';
                ...
                <div className="auth-page-form-panel">
                            ...
                            <div className="auth-page-input-group">
                                <div className="relative flex items-center">
                                    ...
                                    <Input
                                        ...
                                        placeholder={
                                            loginMethod === 'password' ? '用户名 / 邮箱 / 手机号' : '请输入手机号'
                                        }
                                        required
                            ...
                            <div className="auth-page-form-footer">
                                <p>
                                    ...
                                    <Button
                                        type="button"
                                        variant="link"
                                        className="auth-page-switch-link"
                                        onClick={() => setActiveTab('register')}
                                    >
                                        立即注册
                                    </Button>
                    ...
                    {activeTab === 'register' && (
                        <form className="auth-page-form auth-form-entrance" onSubmit={onFormSubmit}>
                            ...
                            <Label
                                htmlFor="agree-terms"
                                className="auth-page-checkbox-label auth-page-terms-checkbox font-normal"
                            >
                                <Checkbox
                                    id="agree-terms"
