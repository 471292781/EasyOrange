        ...
        >
            ...
            >
                ...
                <div
                    style={{
                        ...
                        borderRadius: '50%',
                        background:
                            'radial-gradient(circle, rgba(249,115,22,0.09) 0%, rgba(251,146,60,0.04) 50%, transparent 70%)',
                ...
                <div
                    style={{
                        ...
                        borderRadius: '50%',
                        background:
                            'radial-gradient(circle, rgba(251,113,133,0.07) 0%, rgba(195,155,211,0.05) 50%, transparent 70%)',
                ...
                <div
                    style={{
                        ...
                        animation: 'nfShapeFloat 8s ease-in-out infinite',
                    }}
                />
                <div
                    style={{
                ...
                <div
                    style={{
                        ...
                        animation: 'nfShapeFloat 12s ease-in-out infinite 3s',
                    }}
                />
                <div
                    style={{
            ...
            <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 520, width: '100%' }}>
                ...
                <div
                    style={{
                        marginBottom: '2rem',
                        animation: 'nfIllustrationIn 0.8s cubic-bezier(0.16, 1, 0.3, 1) both',
                    }}
                >
