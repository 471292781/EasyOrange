    ...
    return (
        <div className="payment-result-page-v2">
            ...
            <div className="payment-result-content">
                <div
                    className={`payment-result-icon-wrap ${isSuccess ? 'result-success' : isFailed ? 'result-failed' : 'result-pending'}`}
                >
                ...
                <div className="payment-result-actions">
                    ...
                    {isPending && (
                        <Button className="result-btn result-btn-primary" onClick={() => navigate('/orders')}>
                            <Package size={18} />
                            查看订单
                        </Button>
                    )}
                    ...
                    <Button variant="ghost" className="result-btn result-btn-ghost" onClick={() => navigate('/')}>
                        <Home size={18} />
                        返回首页
                    </Button>
                </div>
