...
export default function ProductManagePage() {
    ...
    const columns: Column<AdminProduct>[] = [
        ...
        },
        {
            key: 'sellerName',
            title: '资产方',
            render: value => <span style={{ color: '#6B6460', fontSize: '0.85rem' }}>{value as string}</span>,
        },
        {
            key: 'conditionLevel',
            title: '成色',
            render: value => (
                <span style={{ color: '#8B857E', fontSize: '0.83rem' }}>{conditionLabels[value as number] || '—'}</span>
            ),
        },
        {
            key: 'status',
