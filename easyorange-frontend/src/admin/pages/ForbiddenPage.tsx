      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 400, width: '100%' }}>
        ...
        <div style={{ position: 'relative', marginBottom: '2rem' }}>
          <div style={{
            ...
            fontSize: 'clamp(6rem, 15vw, 9rem)', fontWeight: 700,
        ...
        <h1 style={{
          ...
          fontSize: '1.5rem', fontWeight: 700, color: '#2A2520',
          marginBottom: '0.6rem',
        }}>
          访问受限
        </h1>
        <p style={{ fontSize: '0.92rem', color: '#9B9590', marginBottom: '2rem', lineHeight: 1.6 }}>
          抱歉，您没有权限访问此页面。<br />如有疑问，请联系管理员。
        </p>
        ...
        <Link
          ...
          style={{
            ...
            padding: '0.7rem 1.6rem', borderRadius: 14,
          ...
          onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 6px 24px rgba(244,63,94,0.38)'; }}
          onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(244,63,94,0.28)'; }}
        >
