    ...
    const columns: Column<AdminRating>[] = [
        ...
        },
        {
            ...
            render: value => {
                ...
                return (
                    <span style={{ fontSize: '0.82rem', fontWeight: 600, color: ratingLabel.color }}>
                        {ratingLabel.emoji}
                    </span>
                );
            },
        },
        {
            ...
            render: value => {
                ...
                return (
                    <span style={{ color: '#6B6460', fontSize: '0.84rem', maxWidth: 160 }} className="truncate block">
                        {name || '未知商品'}
                    </span>
                );
            },
        ...
        },
        {
            ...
            render: value => {
                ...
                return (
                    <span style={{ color: '#9B9590', fontSize: '0.82rem' }}>
                            ...
                            <div style={{ position: 'relative', width: 280 }}>
                                <Input
                                    ...
                                    onFocus={e => {
                                        ...
                                        e.currentTarget.style.boxShadow = '0 0 0 3px rgba(251,113,133,0.08)';
                                    }}
                                    onBlur={e => {
            ...
            <ConfirmModal
                ...
                content={
                    <div style={{ fontSize: '0.88rem', lineHeight: 1.6, color: '#6B6460' }}>
                        <p style={{ marginBottom: '0.75rem' }}>确定要删除该评价吗？删除后将无法恢复。</p>
                        <div
                            style={{
                                padding: '0.75rem',
                                borderRadius: 10,
