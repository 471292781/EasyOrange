...
import { createMockAdminProduct, createMockAdminProductQuery } from '@/testUtils/factories';
import { server } from '@/testUtils/mocks/server';
import { useAdminProductDetail, useAdminProducts, useUpdateProductStatus } from './useAdminProducts';
