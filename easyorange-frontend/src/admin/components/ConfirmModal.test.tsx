...
describe('ConfirmModal', () => {
    ...
    it('calls onConfirm when confirm button clicked', async () => {
        ...
        render(<ConfirmModal isOpen={true} title="确认" content="确定？" onConfirm={onConfirm} onCancel={() => {}} />);
    ...
    it('calls onCancel when cancel button clicked', async () => {
        ...
        render(<ConfirmModal isOpen={true} title="确认" content="确定？" onConfirm={() => {}} onCancel={onCancel} />);
    ...
    it('has dialog role', () => {
        render(<ConfirmModal isOpen={true} title="确认" content="确定？" onConfirm={() => {}} onCancel={() => {}} />);
