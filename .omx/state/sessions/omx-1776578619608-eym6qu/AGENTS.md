...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1776578619608-eym6qu | 2026-04-19T06:03:39.771Z

**Codebase Map:**
  easyorange-frontend/: playwright.config, request, authSession, bootstrap, motion, navigation, overlay-state, routeConfig, Header
  easyorange-miniprogram/: generate-nav-icons, generate-tabbar-icons, wx-adapter, app, header, modal, product-card, skeleton
  easyorange-shared/: ApiClient.d, ApiClient, HttpClient.d, HttpClient, index.d, activity.d, activity, campus.d, campus
