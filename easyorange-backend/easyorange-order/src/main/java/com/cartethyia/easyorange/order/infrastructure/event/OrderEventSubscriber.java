...
public class OrderEventSubscriber implements DomainEventSubscriber<BaseDomainEvent> {
    ...
    public void register() {
        ...
        log.info("OrderEventSubscriber 已注册到 DomainEventRegistry");
    }
    ...
    private void handleOrderCreated(OrderCreatedEvent event) {
        try {
            ...
            log.error("OrderCreatedEvent 处理失败：productId={}", event.getProductId(), e);
            throw e;
        }
    }
    ...
    private void handleOrderCancelled(OrderCancelledEvent event) {
        try {
            ...
            log.error("OrderCancelledEvent 处理失败：productId={}", event.getProductId(), e);
            throw e;
        }
    }
    ...
    private void handleOrderCompleted(OrderCompletedEvent event) {
        try {
            ...
            log.error("OrderCompletedEvent 处理失败：productId={}", event.getProductId(), e);
            throw e;
        }
    }
}
