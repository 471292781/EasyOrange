 ...
 */
@DisplayName("OfflineMessageAggregate — 离线消息聚合根")
class OfflineMessageAggregateTest {
    ...
    void create_shouldSetDefaultState() {
        var aggregate = OfflineMessageAggregate.create("u001", "m001", "email");
    ...
    void fromRaw_shouldReconstructAllFields() {
        var aggregate = OfflineMessageAggregate.fromRaw(
                "id-1", "u001", "m001", "sms",
    ...
    void isPending_whenStatusIsNotPending_shouldReturnFalse() {
        var pending = OfflineMessageAggregate.create("u001", "m001", "email");
