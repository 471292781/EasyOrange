...
class AdminCategoryControllerTest {
    ...
    void listCategories_withParentId_shouldFilterByParent() throws Exception {
        var categories = List.of(new CategoryResponse("3", "手机", "1", null, 2, null, null, null, null, null));
    ...
    void categoryTree_shouldReturnTree() throws Exception {
        var tree = List.of(new CategoryTreeResponse(
                "1", "电子产品", 1, 1, 1, List.of(new CategoryTreeResponse("3", "手机", 2, 1, 1, List.of()))));
