...
class AdminCategoryControllerTest {
    ...
    void listCategories_shouldReturnAll() throws Exception {
        var categories = List.of(
            new CategoryResponse("1", "电子产品", null, null, 1, 1, 1, 10L, null, null),
            new CategoryResponse("2", "服装配饰", null, null, 1, 2, 1, 5L, null, null)
        );
    ...
    void listCategories_withParentId_shouldFilterByParent() throws Exception {
        var categories = List.of(
            new CategoryResponse("3", "手机", "1", null, 2, null, null, null, null, null)
        );
    ...
    void categoryTree_shouldReturnTree() throws Exception {
        var tree = List.of(
            new CategoryTreeResponse("1", "电子产品", 1, 1, 1,
                List.of(
                    new CategoryTreeResponse("3", "手机", 2, 1, 1, List.of())
                )
            )
        );
    ...
    void createCategory_shouldReturnCreated() throws Exception {
        var created = new CategoryResponse("1", "新分类", null, null, 1, 0, 1, null, null, null);
    ...
    void createCategory_withParentId_shouldSucceed() throws Exception {
        var created = new CategoryResponse("4", "子分类", "1", null, 2, null, null, null, null, null);
        when(adminCategoryService.createCategory(any(CategoryCreateRequest.class))).thenReturn(created);
    ...
    void updateCategory_shouldReturnUpdated() throws Exception {
        var updated = new CategoryResponse("1", "更新名称", null, null, 1, null, null, null, null, null);
        when(adminCategoryService.updateCategory(eq("1"), any(CategoryUpdateRequest.class))).thenReturn(updated);
