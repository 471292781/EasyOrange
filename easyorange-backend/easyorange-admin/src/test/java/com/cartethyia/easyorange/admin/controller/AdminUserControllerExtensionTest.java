...
class AdminUserControllerExtensionTest {
    ...
    @MockitoBean
    private AdminUserServiceExtension adminUserServiceExtension;

    @Test
    void unlockUser_shouldSucceed() throws Exception {
        doNothing().when(adminUserServiceExtension).unlockUser(eq(1L), any());
    ...
    void forceLogout_shouldSucceed() throws Exception {
        doNothing().when(adminUserServiceExtension).forceLogout(1L);
    ...
    void changeUserRole_shouldSucceed() throws Exception {
        doNothing().when(adminUserServiceExtension).changeUserRole(eq(1L), any());
