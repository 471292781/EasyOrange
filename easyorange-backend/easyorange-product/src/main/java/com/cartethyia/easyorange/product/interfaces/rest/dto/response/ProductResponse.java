...
public class ProductResponse {
    ...
    public static class ProductResponseBuilder {
        ...
        public ProductResponseBuilder sellerId(Long sellerId) {
            this.sellerId = sellerId;
            return this;
        }
        ...
        public ProductResponseBuilder userAvatar(String userAvatar) {
            this.userAvatar = userAvatar;
            return this;
        }
        ...
        public ProductResponseBuilder originalPrice(BigDecimal originalPrice) {
            this.originalPrice = originalPrice;
            return this;
        }
        ...
        public ProductResponseBuilder status(Integer status) {
            this.status = status;
            return this;
        }

        public ProductResponseBuilder statusDesc(String statusDesc) {
            this.statusDesc = statusDesc;
            return this;
        }

        public ProductResponseBuilder views(Integer views) {
            this.views = views;
            return this;
        }

        public ProductResponseBuilder condition(Integer condition) {
            this.condition = condition;
            return this;
        }

        public ProductResponseBuilder conditionDesc(String conditionDesc) {
            this.conditionDesc = conditionDesc;
            return this;
        }

        public ProductResponseBuilder location(String location) {
            this.location = location;
            return this;
        }

        public ProductResponseBuilder contactMethod(String contactMethod) {
            this.contactMethod = contactMethod;
            return this;
        }

        public ProductResponseBuilder images(List<String> images) {
            this.images = images;
            return this;
        }

        public ProductResponseBuilder mainImageUrl(String mainImageUrl) {
            this.mainImageUrl = mainImageUrl;
            return this;
        }

        public ProductResponseBuilder createTime(LocalDateTime createTime) {
            this.createTime = createTime;
            return this;
        }

        public ProductResponseBuilder updateTime(LocalDateTime updateTime) {
            this.updateTime = updateTime;
            return this;
        }
