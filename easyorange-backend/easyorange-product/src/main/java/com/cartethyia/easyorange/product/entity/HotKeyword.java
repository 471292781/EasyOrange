...
public class HotKeyword extends BaseDO {
    ...
    public HotKeyword(String keyword, Integer searchCount, LocalDateTime lastSearchTime) {
    ...
    public static class Builder {
        ...
        public HotKeyword build() {
            return new HotKeyword(keyword, searchCount, lastSearchTime);
        }
    }
}