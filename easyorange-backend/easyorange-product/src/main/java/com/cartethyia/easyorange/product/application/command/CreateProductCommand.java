...
public class CreateProductCommand {
    ...
    public CreateProductCommand(Long categoryId, String name, BigDecimal price, BigDecimal originalPrice,
    ...
    public static class Builder {
        ...
        public CreateProductCommand build() {
            return new CreateProductCommand(categoryId, name, price, originalPrice, stock,
