package com.cartethyia.easyorange.product.infrastructure.persistence.converter;
...
public final class ProductConverter {
    ...
    public Product toDomain(ProductDO productDO, ProductDetailDO detailDO, List<ProductImageDO> imageDOs) {
        return Product.reconstitute(
                ...
                ProductStatusVO.of(productDO.getStatus()),
                productDO.getViewCount(),
                ConditionLevelVO.of(productDO.getConditionLevel()),
    ...
    public ImageSet toImageSet(List<ProductImageDO> imageDOs) {
        ...
        List<ImageSet.ProductImageVO> images = imageDOs.stream()
    ...
    public ProductDO toDataObject(Product product) {
        ...
        dobj.setStatus(product.getStatus().code());
        dobj.setViewCount(product.getViewCount());
        dobj.setConditionLevel(product.getConditionLevel() != null ? product.getConditionLevel().code() : null);
        dobj.setLocation(product.getLocation() != null ? product.getLocation().value() : null);
        dobj.setContactMethod(product.getContactMethod() != null ? product.getContactMethod().value() : null);
