...
@DisplayName("PasswordResetAppService 测试")
class PasswordResetAppServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new PasswordResetAppService(authenticationDomainService, userEventPort);
    }
    ...
    void forgotPassword_userExists() {
        ...
        User user = User.builder()
            ...
            .build();
        when(authenticationDomainService.resetPassword(phone, verifyCode, newPassword))
            .thenReturn(user);
