...
class PasswordAnnotationTest {
    ...
    void passwordTargetsFieldAndParameter() {
        var targets = Password.class.getAnnotation(java.lang.annotation.Target.class).value();
    ...
    void passwordHasCorrectRetention() {
        assertThat(Password.class.getAnnotation(java.lang.annotation.Retention.class).value())
