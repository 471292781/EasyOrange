...
@DisplayName("UserRegistrationDomainService 测试")
class UserRegistrationDomainServiceTest {
    ...
    private UserRegistrationDomainService service;
    ...
    @BeforeEach
    void setUp() {
        service = new UserRegistrationDomainService(userRepository, passwordEncoder);
    }
    ...
    class RegisterTests {
        ...
        void success_withoutContact() {
            ...
            User result = service.register(USERNAME, PASSWORD, null, null, NICKNAME);
        ...
        void success_withContact() {
            ...
            User result = service.register(USERNAME, PASSWORD, PHONE, EMAIL, NICKNAME);
        ...
        void usernameAlreadyExists() {
            ...
            assertThatThrownBy(() -> service.register(USERNAME, PASSWORD, null, null, NICKNAME))
        ...
        void phoneAlreadyExists() {
            ...
            assertThatThrownBy(() -> service.register(USERNAME, PASSWORD, PHONE, null, NICKNAME))
                .isInstanceOf(BusinessException.class)
        ...
        void emailAlreadyExists() {
            ...
            assertThatThrownBy(() -> service.register(USERNAME, PASSWORD, null, EMAIL, NICKNAME))
                .isInstanceOf(BusinessException.class)
